...
namespace Simplex
{
	...
	class MyOctant
	{
		...
		vector3 point1 = vector3(0.0f);
		vector3 point2 = vector3(0.0f);
		vector3 point3 = vector3(0.0f);
		vector3 point4 = vector3(0.0f);
		vector3 point5 = vector3(0.0f);
		vector3 point6 = vector3(0.0f);
		vector3 point7 = vector3(0.0f);
		vector3 point8 = vector3(0.0f);
