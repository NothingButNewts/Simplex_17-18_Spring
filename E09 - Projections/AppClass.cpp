...
void Application::Display(void)
{
	...
	case 3:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUp(vector3(15.0f, 0.0f, 0.0f), vector3(0.0f, 0.0f, 0.0f), vector3(0.0f, 1.0f, 0.0f));
		break;
	case 4:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUp(vector3(0.0f, 0.0f, -15.0f), vector3(0.0f, 0.0f, 0.0f), vector3(0.0f, 1.0f, 0.0f));
	...
	case 5:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUp(vector3(0.0f, 0.0f, -15.0f), vector3(0.0f, 0.0f, 0.0f), vector3(0.0f, 1.0f, 0.0f));
		//m_pCamera->SetNearFar(vector2(0.0, 0.0f));
		break;
	case 6:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUp(vector3(0.0f, 0.0f, 8.0f), vector3(0.0f, 0.0f, 0.0f), vector3(0.0f, 1.0f, 0.0f));
		break;
	case 7:
		m_pCamera->ResetCamera();
		break;
